...
/**
 * Small application to attempt to generate all Xilinx devices in the Sqlite format.
 */
public class GenerateSqliteDevices {
    public static void main(String[] args) {
        if (args.length != 1) {
            System.out.println("USAGE: java " + GenerateSqliteDevices.class.getCanonicalName()
                    + " <destination_dir>");
            return;
        }
        ...
        for (String deviceName : Device.getAvailableDevices()) {
            ...
            job.setCommand("java " + DeviceResourcesExampleSqlite.class.getCanonicalName() + " " + deviceName);
