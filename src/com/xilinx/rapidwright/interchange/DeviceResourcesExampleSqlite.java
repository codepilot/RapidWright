...
public class DeviceResourcesExampleSqlite {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String sqliteFileName = args[0] + ".device.sqlite3";
        t.start("Load Device");
        ...
        DeviceResourcesVerifierSqlite.verifyDeviceResources(sqliteFileName, args[0]);
